...
export function GlobalSearch() {
  ...
  return (
    <div ref={containerRef} className="relative">
      <div className="flex items-center gap-2 bg-slate-100 border border-slate-200 rounded-lg px-3 py-1.5 w-56">
        ...
        {!loading && <kbd className="text-xs text-slate-300 font-mono">⌃K</kbd>}
      </div>

      {open && query.length >= 2 && (
        <div className="absolute right-0 top-full mt-1 w-80 bg-white border border-slate-200 rounded-xl shadow-lg z-50 py-2 max-h-96 overflow-y-auto">
          {!hasResults(results) ? (
            ...
            <>
              {results.accounts.length > 0 && (
                <div>
                  <div className="px-4 py-1.5 text-xs font-semibold text-slate-400 uppercase tracking-wide">Accounts</div>
              ...
              {results.journal_entries.length > 0 && (
                <div>
                  <div className="px-4 py-1.5 text-xs font-semibold text-slate-400 uppercase tracking-wide">Journal Entries</div>
              ...
              {results.phrases.length > 0 && (
                <div>
                  <div className="px-4 py-1.5 text-xs font-semibold text-slate-400 uppercase tracking-wide">Phrases</div>
